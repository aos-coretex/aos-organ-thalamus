...
export function createJobLifecycle({ spineStateClient, jobStore }) {
  ...
  async function createJob({ source, originator_ref, reply_to, priority, description }) {
    ...
    log('thalamus_job_created', { job_urn: jobUrn, source, originator_ref, priority: jobRecord.priority });
